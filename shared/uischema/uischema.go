	...
	},
	{
		...
		Actions: []ActionDetail{
			...
			},
			{
				...
				OutputType:  "text",
				// No UnixAction: CLI escape via JoinCluster. Hidden so generic interpreters
				// (InvokeDomainAction) do not surface a broken action.
				Hidden: true,
				Parameters: []ParameterDetail{
	...
	},
	{
		...
		Actions: []ActionDetail{
			...
			},
			{
				...
				OutputType:  "text",
				// No UnixAction / no daemon handler: CLI TUI escape only. Hidden so
				// generic interpreters do not surface a broken action.
				Hidden: true,
				Parameters: []ParameterDetail{
